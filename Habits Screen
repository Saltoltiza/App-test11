...
const HabitsScreen = () => {
  ...
  const categories = ['Health', 'Productivity', 'Learning', 'Social', 'Finance', 'Mindfulness'];
        ...
        <View style={styles.habitDetails}>
          ...
          {item.reminderTime && (
            <View style={styles.detailItem}>
              ...
              <Text style={styles.detailText}>{item.reminderTime}</Text>
            </View>
          )}
          <View style={styles.detailItem}>
            <Icon name="flame" size={16} color="#FF6B6B" />
            <Text style={styles.detailText}>{item.streak || 0} days</Text>
          </View>
        </View>
      </View>
    </View>
    ...
    <View style={styles.container}>
      ...
      {habits.length > 0 ? (
        ...
        <View style={styles.emptyState}>
          <Icon name="checkmark-circle-outline" size={80} color="#CCCCCC" />
          <Text style={styles.emptyStateTitle}>No Habits Yet</Text>
          <Text style={styles.emptyStateText}>
            Start building your personal improvement journey
          </Text>
                  ...
                  {frequencies.map((frequency) => (
                    <TouchableOpacity
                      ...
                      style={[
                        ...
                        formData.frequency === frequency && styles.frequencyOptionSelected,
                      ]}
                      onPress={() => setFormData({...formData, frequency})}
                    >
                      <Text style={[
                        styles.frequencyOptionText,
                        formData.frequency === frequency && styles.frequencyOptionTextSelected,
                      ]}>
                        {frequency}
                      </Text>
                    </TouchableOpacity>
